...
// ================================================================
	...
	#define is_analog_a0 0			// 1 to enable Feather A_ ports as analog inputs 
...
// ================================================================
	...
	#define is_mpu6050         1	// Accelerometer / Gyroscope (NOTE* I2C address conflicts with RTC if not manually changed) (much better supported on Ishield)
